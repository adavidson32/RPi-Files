...
class variables:
    def __init__(self):
        self.Outlets = {'O1': {'pin': 6, 'type': 'none' , 'name': 'O1'         , 'state': 0, 't_change': 0},
                        'O2': {'pin': 5 , 'type': 'none' , 'name': 'O2'         , 'state': 0, 't_change': 0},
                        'O3': {'pin': 19 , 'type': 'light', 'name': 'room lights' , 'state': 0, 't_change': 0},
                        'O4': {'pin': 13, 'type': 'light', 'name': 'desk light', 'state': 0, 't_change': 0}}
